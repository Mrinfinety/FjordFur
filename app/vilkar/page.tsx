    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#fafaf8', minHeight: '100vh' }}>
      ...
      <div className="rcontainer">
        ...
        <div className="rsection">
          <h2 className="rsection-title">Om NordicPaws</h2>
          <p>NordicPaws er en norsk nettbutikk som selger kjæledyrutstyr. Ved å handle hos oss godtar du disse vilkårene.</p>
          <p>Kontakt: kontakt.nordicpaws@gmail.com</p>
        </div>

        <div className="rsection">
          <h2 className="rsection-title">Bestilling og betaling</h2>
          <p>Alle priser er oppgitt i norske kroner (NOK). Betaling skjer sikkert via Stripe som støtter alle vanlige betalingskort samt Vipps.</p>
        ...
        <div className="rsection">
          ...
          <p>Du har 14 dagers angrerett fra mottak av varen, i henhold til norsk forbrukerkjøpslov.</p>
          <p>Vi refunderer hele kjøpesummen uten at du trenger å sende varen tilbake. Refusjon behandles innen 5–10 virkedager.</p>
          <p>For å benytte angreretten, kontakt oss på kontakt.nordicpaws@gmail.com.</p>
        </div>

        <div className="rsection">
          <h2 className="rsection-title">Reklamasjon</h2>
          <p>Mottar du et defekt eller feil produkt har du reklamasjonsrett i henhold til forbrukerkjøpsloven. Kontakt oss på kontakt.nordicpaws@gmail.com med bilde av produktet.</p>
